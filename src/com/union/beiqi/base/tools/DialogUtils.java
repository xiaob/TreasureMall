...
public class DialogUtils
{
	...
	public static void showLoading(Object context)
	{
		if (loading == null)
		{
			...
			{
				loading = createDialog(((Fragment) context).getActivity(), R.style.Loading_Dialog);
			} else
			{
				loading = createDialog(((FragmentActivity) context), R.style.Loading_Dialog);
			}
	...
	public static void showError(Object context)
	{
		if (isFragment(context))
		{
			error = createDialog(((Fragment) context).getActivity(), R.style.Error_Dialog);
		} else
		{
			error = createDialog(((FragmentActivity) context), R.style.Error_Dialog);
		}
